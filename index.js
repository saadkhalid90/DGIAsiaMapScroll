async function readAndDraw(){
  ...
  const steps = [
    {
      ...
      doingBetter: [],
      doingWell: [],
      default: allMapCountries
    },
    {
      countries: countriesOld,
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !countriesOld.includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
    ...
    {
      countries: ["Bangladesh", "Cambodia", "India", "Myanmar", "Nepal", "Pakistan", "Philippines", "Singapore", "Sri Lanka", "Vietnam"],
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !["Bangladesh", "Cambodia", "India", "Myanmar", "Nepal", "Pakistan", "Philippines", "Singapore", "Sri Lanka", "Vietnam"].includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
    ...
    {
      countries: ["Sri Lanka", "Malaysia", "Hong Kong S.A.R.", "Indonesia", "Pakistan", "Vietnam", "China"],
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !["Sri Lanka", "Malaysia", "Hong Kong S.A.R.", "Indonesia", "Pakistan", "Vietnam", "China"].includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
    ...
    {
      countries: ["Bangladesh", "China", "India", "Indonesia", "Myanmar", "Nepal", "Pakistan", "Philippines", "Thailand", "Vietnam"],
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !["Bangladesh", "China", "India", "Indonesia", "Myanmar", "Nepal", "Pakistan", "Philippines", "Thailand", "Vietnam"].includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
    ...
    {
      countries: ["China", "Hong Kong S.A.R.", "Indonesia", "Japan", "Malaysia", "Myanmar", "Pakistan", "Philippines", "Singapore", "South Korea", "Sri Lanka", "Taiwan", "Thailand", "Vietnam"],
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !["China", "Hong Kong S.A.R.", "Indonesia", "Japan", "Malaysia", "Myanmar", "Pakistan", "Philippines", "Singapore", "South Korea", "Sri Lanka", "Taiwan", "Thailand", "Vietnam"].includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
    ...
    {
      countries: ["China", "Hong Kong S.A.R.", "India", "Malaysia", "Myanmar", "Pakistan", "Philippines", "Sri Lanka", "Taiwan", "Thailand", "South Korea"],
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !["China", "Hong Kong S.A.R.", "India", "Malaysia", "Myanmar", "Pakistan", "Philippines", "Sri Lanka", "Taiwan", "Thailand", "South Korea"].includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
    ...
    {
      countries: ["Bangladesh", "China", "India", "Indonesia", "Japan", "Malaysia", "Pakistan", "Philippines", "Thailand", "Vietnam", "South Korea"],
      countriesNew: [],
      countriesGrey: allMapCountries.filter(d => !["Bangladesh", "China", "India", "Indonesia", "Japan", "Malaysia", "Pakistan", "Philippines", "Thailand", "Vietnam", "South Korea"].includes(d)),
      notDoingEnough: [],
      doingOkay: [],
      doingBetter: [],
      doingWell: [],
  ...
  const worldPath = ctryGrp.selectAll('path.country')
    ...
    d3.select('select#mapStateSelect').on('input', function(d, i){
      const idx = this.value;
      console.log(idx);
      switchMapState(d3.selectAll('path.country'), steps, idx);
    })
    ...
    function switchMapState(mapSelection, stateMap, index){
      ...
      console.log(mapSelection.data());
      console.log(d3.selectAll('path.country').data());
